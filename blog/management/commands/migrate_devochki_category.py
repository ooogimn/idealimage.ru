"""
Management команда для переноса статей из категории "ДЕВОЧКИ КОСИЧКИ" (ID=5)
в категорию "Малыши и Мамы" (ID=38) с добавлением тега "ДЕВОЧКИ КОСИЧКИ"
"""
...
class Command(BaseCommand):
    help = 'Переносит статьи из "ДЕВОЧКИ КОСИЧКИ" в "Малыши и Мамы" с тегом'
    ...
    def handle(self, *args, **options):
        ...
        FROM_ID = 5   # ДЕВОЧКИ КОСИЧКИ
        TO_ID = 38    # Малыши и Мамы
        TAG_NAME = "ДЕВОЧКИ КОСИЧКИ"
        
        self.stdout.write(self.style.WARNING('=' * 80))
        self.stdout.write(self.style.WARNING('МИГРАЦИЯ КАТЕГОРИИ "ДЕВОЧКИ КОСИЧКИ"'))
        self.stdout.write(self.style.WARNING('=' * 80))
