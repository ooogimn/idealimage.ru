"""
Management команда для переноса статей из категории "ЛАПОЧКИ-МАЛЫШКИ" (ID=22)
в категорию "Малыши и Мамы" (ID=38) с добавлением тега "ЛАПОЧКИ-МАЛЫШКИ"
"""
...
class Command(BaseCommand):
    help = 'Переносит статьи из "ЛАПОЧКИ-МАЛЫШКИ" в "Малыши и Мамы" с тегом'
    ...
    def handle(self, *args, **options):
        ...
        FROM_ID = 22  # ЛАПОЧКИ-МАЛЫШКИ
        TO_ID = 38    # Малыши и Мамы
        TAG_NAME = "ЛАПОЧКИ-МАЛЫШКИ"
        
        self.stdout.write(self.style.WARNING('=' * 80))
        self.stdout.write(self.style.WARNING('МИГРАЦИЯ КАТЕГОРИИ "ЛАПОЧКИ-МАЛЫШКИ"'))
        self.stdout.write(self.style.WARNING('=' * 80))
