"""
Management команда для переноса статей из категории "Я - МАМОЧКА" (ID=21)
в категорию "Малыши и Мамы" (ID=38) с добавлением тега "Я - МАМОЧКА"
"""
...
class Command(BaseCommand):
    help = 'Переносит статьи из "Я - МАМОЧКА" в "Малыши и Мамы" с тегом'
    ...
    def handle(self, *args, **options):
        ...
        FROM_ID = 21  # Я - МАМОЧКА
        TO_ID = 38    # Малыши и Мамы
        TAG_NAME = "Я - МАМОЧКА"
        
        self.stdout.write(self.style.WARNING('=' * 80))
        self.stdout.write(self.style.WARNING('МИГРАЦИЯ КАТЕГОРИИ "Я - МАМОЧКА"'))
        self.stdout.write(self.style.WARNING('=' * 80))
