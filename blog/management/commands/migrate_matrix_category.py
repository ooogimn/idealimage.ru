"""
Management команда для переноса статей из категории "Матрица СУДЬБЫ" (ID=19)
в категорию "Интеллектуальные Прогнозы" (ID=37) с добавлением тега "Матрица СУДЬБЫ"
"""
...
class Command(BaseCommand):
    help = 'Переносит статьи из "Матрица СУДЬБЫ" в "Интеллектуальные Прогнозы" с тегом'
    ...
    def handle(self, *args, **options):
        ...
        FROM_ID = 19  # Матрица СУДЬБЫ
        TO_ID = 37    # Интеллектуальные Прогнозы
        TAG_NAME = "Матрица СУДЬБЫ"
        
        self.stdout.write(self.style.WARNING('=' * 80))
        self.stdout.write(self.style.WARNING('МИГРАЦИЯ КАТЕГОРИИ "Матрица СУДЬБЫ"'))
        self.stdout.write(self.style.WARNING('=' * 80))
