"""
Management команда для переноса статей из категории "СТУДЕНЧИСКАЯ МАГИЯ" (ID=16) 
в категорию "ПСИХОЛОГИЯ" (ID=14) с добавлением тега "СТУДЕНЧИСКАЯ МАГИЯ"
"""
...
class Command(BaseCommand):
    help = 'Переносит статьи из "СТУДЕНЧИСКАЯ МАГИЯ" в "ПСИХОЛОГИЯ" с тегом'
    ...
    def handle(self, *args, **options):
        ...
        FROM_ID = 16  # СТУДЕНЧИСКАЯ МАГИЯ
        TO_ID = 14    # ПСИХОЛОГИЯ
        TAG_NAME = "СТУДЕНЧИСКАЯ МАГИЯ"
        
        self.stdout.write(self.style.WARNING('=' * 80))
        self.stdout.write(self.style.WARNING('МИГРАЦИЯ КАТЕГОРИИ "СТУДЕНЧИСКАЯ МАГИЯ"'))
        self.stdout.write(self.style.WARNING('=' * 80))
